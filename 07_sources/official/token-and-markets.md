...
## Best Use
- token overview
- supply / issuance / circulating amount
- exchange listing references
- cross-chain token deployment references

## Notes
- Market numbers are time-sensitive, so future writeups should attach a date.
- Contract addresses should be checked against official Orbs pages where possible before publishing final summaries.
