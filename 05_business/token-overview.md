...
## Supply Snapshot (user-provided, as of 2026-04-22)
- Market Cap: $44,257,588
- Fully Diluted Valuation: $89,791,178
...
## Important Notes
- These figures are time-dependent and should always be recorded with a date
- Circulating supply can be rechecked periodically against `https://status.orbs.network/supply`
