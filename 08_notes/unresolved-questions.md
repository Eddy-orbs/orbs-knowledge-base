...
- Need direct export or CSV of the partner Google Sheet to build a current authoritative partner table.
- Need stronger extraction from the ecosystem page, which appears image-heavy and did not yield useful text through simple fetch.
